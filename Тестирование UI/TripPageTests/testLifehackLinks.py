...
# Тестирование загрузки разделов лайфхаков страницы вариантов передвижения
class TestLifehack(unittest.TestCase):

    def setUp(self):
        chromePath = "/Users/user/anaconda3/IcelandTravelUITests/chromedriver"
        self.url = "http://192.168.1.33:8080/trip"
    ...
    # Переходы на разделы лайфхаков из страницы вариантов передвижения
    def testLoadLifehackPages(self):
        driver = self.driver

        lifehacksArray = ["#plane", "#ferry", "#loanAuto"]
