...
<script>
import carouselWithButton from '@/components/homePageComponents/carouselWithButton.vue'
import listChapters from '@/components/listChapters.vue'
import mainDescription from '@/components/homePageComponents/mainDescription.vue'
import carouselBase from '@/components/carouselBase.vue'
import videoContent from '@/components/homePageComponents/videoContent.vue'
import sectionComponent from '@/components/section.vue'
export default{
    data(){
      return{
        listContents: [
          {id: 0, text: "Средневековая-столица-викингов", photoPath: require('@/assets/homePageImages/startPage1.jpg'), activeForFirst: "carousel-item active"},
          {id: 1, text: "Бассейн-под открытым-небом", photoPath: require('@/assets/homePageImages/startPage2.jpg'), activeForFirst: "carousel-item"},
          {id: 2, text: "Уникальный-галечный-пляж", photoPath: require('@/assets/homePageImages/startPage3.jpg'), activeForFirst: "carousel-item"},
        ],
        generalNameChapters: "Полезные лайфхаки",
        generalLogoChapters: "fas fa-paperclip mr-2",
        listChapters: [
          {id: 0, text: "Столица", photoPath: require('@/assets/homePageImages/startPage4.jpg')},
          {id: 1, text: "Что посмотреть", photoPath: require('@/assets/homePageImages/startPage5.jpg')},
          {id: 2, text: "Кухня",  photoPath: require('@/assets/homePageImages/startPage6.jpg')},
          {id: 3, text: "Как добраться",  photoPath: require('@/assets/homePageImages/startPage7.png')},
          {id: 4, text: "Где жить",  photoPath: require('@/assets/homePageImages/startPage8.jpg')},
          {id: 5, text: "На заметку",  photoPath: require('@/assets/homePageImages/startPage9.jpg')},
        ],
        ...
        basePicturePath: require('@/assets/homePageImages/startPage10.jpg'),
        listPhotosPath: [
          {id: 0, photoPath: require('@/assets/homePageImages/startPage11.jpg'), activeForFirst: "carousel-item active"},
          {id: 1, photoPath: require('@/assets/homePageImages/startPage12.jpg'), activeForFirst: "carousel-item"},
          {id: 2, photoPath: require('@/assets/homePageImages/startPage13.jpg'), activeForFirst: "carousel-item"},
        ],
        videoLink: "https://www.youtube.com/embed/wb84vvYSPEU",
        nameSection: "На заметку",
        sectionSticker: "fas fa-mobile-alt mr-2",
        listFourNotes: [
          {id: 0, text: "Stætó.is (Android) / (iPhone) – приложение с расписанием и маршрутом автобусов.", keyword:"Stætó.is (Android) / (iPhone)"},
          {id: 1, text: "Appy Hour (Android) / (iPhone) – подсказывает счастливые часы в заведениях, когда можно попасть на неплохую скидку.", keyword:"Appy Hour (Android) / (iPhone) ", photoPath: require('@/assets/cityPageImages/cityPageSub1.jpg')},
          {id: 2, text: "AuroraNotifier и Aurora Forecast – расскажут о шансах увидеть северное сияние над Рейкьявиком.", keyword:"AuroraNotifier и Aurora Forecast", photoPath: require('@/assets/cityPageImages/cityPageSub2.jpg')},
          {id: 3, text: "Название города правильно произносить с ударением на последний слог – РейкьявИк.", keyword:"РейкьявИк"},
        ]
      }
    },
  computed: {
...
<style lang="css">
  @import '../components/projectStyleFile.css'
</style>